      ...
      <div class="row">
        <div class="col-md-offset-4 col-md-8">
          <p class="text-justify">
            Among The Source’s 15 merchants are Acorn, a wood-fired restaurant and cocktail bar owned by the team behind Oak at Fourteenth; Comida, a modern Mexican taqueria; and Babettes Artisan Breads, a traditional French bakery. Beet & Yarrow brings a keen eye to floral design and offers local, seasonal produce. Vendors also include SVPER ORDINARY, a design store and gallery space; The Proper Pour, an independent wine and spirits bottle shop, and Crooked Stave Artisan Beer Project, a cultish brewery specializing in funky and sour beers. Also setting up shop at The Source are Boulder-based Boxcar Coffee Roasters and Mondo Market, a cheese, spice, and specialty food store. RiNo Yacht Club rounds out the list serving cocktails, wine, beer, and small plates at the central bar. 
          </p>
          <p class="text-justify">
